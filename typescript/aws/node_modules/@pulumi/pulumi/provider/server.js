...
const settings = require("../runtime/settings");
const rpc = require("../runtime/rpc");
...
function configureRuntime(req, engineAddr) {
    ...
    settings.resetOptions(req.getProject(), req.getStack(), req.getParallel(), engineAddr, req.getMonitorendpoint(), req.getDryrun());
    const pulumiConfig = {};
...
function main(provider, args) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const engineAddr = (_a = parsedArgs) === null || _a === void 0 ? void 0 : _a.engineAddress;
