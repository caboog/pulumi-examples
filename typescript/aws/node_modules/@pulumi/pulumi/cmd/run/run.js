...
const stack = require("../../runtime/stack");
...
function run(argv, programStarted, reportLoggedError, isErrorReported) {
    ...
    if (typeScript) {
        const transpileOnly = (_b = process.env["PULUMI_NODEJS_TRANSPILE_ONLY"], (_b !== null && _b !== void 0 ? _b : "false")) === "true";
    ...
    const uncaughtHandler = (err) => {
        ...
        // First, log the error.
        if (errors_1.RunError.isInstance(err) || typeof err == typeof tsnode.TSError) {
